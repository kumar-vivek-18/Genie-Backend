...
export const availableCategories = async (req, res) => {
    try {
        const searchData = [
            ...
            { id: 23, title: 'Hardware', subTitle: 'Cement, Hand tools, Powertools etc' },
            { id: 24, title: 'Home & Function Decoration', subTitle: '' },
            { id: 25, title: 'Home Furnishing', subTitle: 'Blanket, Pillow, Curtains etc' },
            { id: 26, title: 'Home Furnishing', subTitle: 'Furniture etc' },
            { id: 27, title: 'Kids Games,Toys & Clothings', subTitle: '' },
            ...
            { id: 31, title: 'Music instruments , Accessories & maintenance services', subTitle: '' },
            { id: 32, title: 'Paintings & Art', subTitle: '' },
            { id: 33, title: 'Pet Care & Food', subTitle: '' },
            { id: 34, title: 'Plants & Gardening Accessories', subTitle: '' },
            { id: 35, title: 'Services & Repair, Consumer Electronics & Accessories', subTitle: 'Home appliances and equipment etc' },
            { id: 36, title: 'Services & Repair, Consumer Electronics & Accessories', subTitle: 'Mobile, Laptop, digital products etc' },
            { id: 37, title: 'Services & Repair, Heavy Construction & Commercial Vehicles', subTitle: 'JCB, Cranes, Trucks etc' },
            { id: 38, title: 'Sports Accessories & Services', subTitle: 'Cricket, Football, Basketball etc' },
            { id: 39, title: 'Sports Nutrition', subTitle: 'Whey Pro etc' },
            { id: 40, title: 'Stationary & Book Stores', subTitle: '' },
            { id: 41, title: 'Tailor', subTitle: 'Makes or alters clothing' }
        ];
