...
export const availableCategories = async (req, res) => {
    try {
        const searchData = [
            ...
            { id: 25, title: 'Hardware', subTitle: 'Plumbing, Paint,& Electricity' },
            { id: 26, title: 'Home & Function Decoration', subTitle: '' },
            { id: 27, title: 'Home Furnishing', subTitle: 'Blanket, Pillow, Curtains etc' },
            { id: 28, title: 'Home Furnishing', subTitle: 'Furniture etc' },
            { id: 29, title: 'Gifts, Kids Games,Toys & Clothings', subTitle: '' },
            ...
            { id: 33, title: 'Music instruments , Accessories & maintenance services', subTitle: '' },
            { id: 34, title: 'Paintings & Art', subTitle: '' },
            { id: 35, title: 'Pet Care & Food', subTitle: '' },
            { id: 36, title: 'Plants & Gardening Accessories', subTitle: '' },
            { id: 37, title: 'Services & Repair, Consumer Electronics & Accessories', subTitle: 'Home appliances and equipment etc' },
            { id: 38, title: 'Services & Repair, Consumer Electronics & Accessories', subTitle: 'Mobile, Laptop, digital products etc' },
            { id: 39, title: 'Services & Repair, Heavy Construction & Commercial Vehicles', subTitle: 'JCB, Cranes, Trucks etc' },
            { id: 40, title: 'Sports Accessories & Services', subTitle: 'Cricket, Football, Basketball etc' },
            { id: 41, title: 'Sports Nutrition', subTitle: 'Whey Pro etc' },
            { id: 42, title: 'Stationary & Book Stores', subTitle: '' },
            { id: 43, title: 'Tailor', subTitle: 'Makes or alters clothing' }
        ];
