...
export const availableCategories = async (req, res) => {
    try {
        const searchData = [
            ...
            { id: 32, title: 'Services & Repair- Consumer Electronics Services & Accessories', subTitle: 'Home appliances and equipment etc' },
            { id: 33, title: 'Services & Repair- Consumer Electronics Services & Accessories', subTitle: 'Mobile, Laptop, digital products etc' },
