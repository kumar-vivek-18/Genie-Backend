...
import { getRetailerNewChats, getRetailerOngoingChats, getChats, sendMessage, updateMessage, getSpadeMessages, modifyChat, acceptBid } from '../controllers/chatController.js';
...
router.route('/accept-bid').patch(acceptBid);
